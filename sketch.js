...
function setup() {
  ...
  solo = createSprite(200,windowHeight-20,400,20);
  solo.addImage("ground",imagemdosolo);
  solo.x = solo.width /2;
  solo.velocityX = -4;
  
  soloinvisivel = createSprite(200,windowHeight-20,400,10);
...
function gerarObstaculos(){
 if (frameCount % 60 === 0){
   var obstaculo = createSprite(windowWidth,windowHeight-35,10,40);
